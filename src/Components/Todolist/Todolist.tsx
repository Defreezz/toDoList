...
const Todolist = React.memo( function ({
    ...
    const onAllClickHandler = useCallback(() => {changeTaskFilter("all",todolistID)},
        [changeTaskFilter,todolistID])
    const onActiveClickHandler = useCallback(() => {changeTaskFilter("active",todolistID)},
        [changeTaskFilter,todolistID])
    const onCompletedClickHandler = useCallback (() => {changeTaskFilter("completed",todolistID)},
        [changeTaskFilter,todolistID])
